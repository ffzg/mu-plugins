<?php
/**
 * Plugin Name: WP fail2ban FFZG
 * Plugin URI: https://github.com/ffzg/wp-fail2ban-ffzg
 * Description: Write all login attempts to syslog for integration with fail2ban.
 * Text Domain: wp-fail2ban-ffzg
 * Version: 4.0.0
 * Author: Charles Lecklider and Dobrica Pavlinušić
 * Author URI: https://blog.rot13.org
 * License: GPL2
...
namespace hr\ffzg\wordpress\wp_fail2ban_ffzg;
